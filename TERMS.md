...
The plugin is intended for development, testing, review preparation, and other authorized workflows. Review the agent's actions and use test or staging accounts where practical.
